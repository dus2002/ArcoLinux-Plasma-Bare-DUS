...
function AURInstalls() {
	sudo -u liveuser yay --noconfirm -S dolphin-root-git pamac-aur-git pamac-aur-tray-appindicator-git peazip-qt qt4pas-mirror kde-servicemenus-peazip gnome-system-tools
}
function Snapd() {
